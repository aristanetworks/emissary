...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*RateLimitGRPCConfig)(nil), (*v3alpha1.RateLimitGRPCConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v2_RateLimitGRPCConfig_To_v3alpha1_RateLimitGRPCConfig(a.(*RateLimitGRPCConfig), b.(*v3alpha1.RateLimitGRPCConfig), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*v3alpha1.RateLimitGRPCConfig)(nil), (*RateLimitGRPCConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v3alpha1_RateLimitGRPCConfig_To_v2_RateLimitGRPCConfig(a.(*v3alpha1.RateLimitGRPCConfig), b.(*RateLimitGRPCConfig), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*StatusRange)(nil), (*v3alpha1.StatusRange)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v2_StatusRange_To_v3alpha1_StatusRange(a.(*StatusRange), b.(*v3alpha1.StatusRange), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*v3alpha1.StatusRange)(nil), (*StatusRange)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v3alpha1_StatusRange_To_v2_StatusRange(a.(*v3alpha1.StatusRange), b.(*StatusRange), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v2_RateLimitGRPCConfig_To_v3alpha1_RateLimitGRPCConfig(in *RateLimitGRPCConfig, out *v3alpha1.RateLimitGRPCConfig, s conversion.Scope) error {
	*out = v3alpha1.RateLimitGRPCConfig(*in)
	return nil
}

// Convert_v2_RateLimitGRPCConfig_To_v3alpha1_RateLimitGRPCConfig is an autogenerated conversion function.
func Convert_v2_RateLimitGRPCConfig_To_v3alpha1_RateLimitGRPCConfig(in *RateLimitGRPCConfig, out *v3alpha1.RateLimitGRPCConfig, s conversion.Scope) error {
	return autoConvert_v2_RateLimitGRPCConfig_To_v3alpha1_RateLimitGRPCConfig(in, out, s)
}

func autoConvert_v3alpha1_RateLimitGRPCConfig_To_v2_RateLimitGRPCConfig(in *v3alpha1.RateLimitGRPCConfig, out *RateLimitGRPCConfig, s conversion.Scope) error {
	*out = RateLimitGRPCConfig(*in)
	return nil
}

// Convert_v3alpha1_RateLimitGRPCConfig_To_v2_RateLimitGRPCConfig is an autogenerated conversion function.
func Convert_v3alpha1_RateLimitGRPCConfig_To_v2_RateLimitGRPCConfig(in *v3alpha1.RateLimitGRPCConfig, out *RateLimitGRPCConfig, s conversion.Scope) error {
	return autoConvert_v3alpha1_RateLimitGRPCConfig_To_v2_RateLimitGRPCConfig(in, out, s)
}
...
func autoConvert_v2_RateLimitServiceSpec_To_v3alpha1_RateLimitServiceSpec(in *RateLimitServiceSpec, out *v3alpha1.RateLimitServiceSpec, s conversion.Scope) error {
	...
	if true {
		in, out := &in.V3GRPC, &out.GRPC
		if *in == nil {
			*out = nil
		} else {
			*out = new(v3alpha1.RateLimitGRPCConfig)
			in, out := *in, *out
			if err := Convert_v2_RateLimitGRPCConfig_To_v3alpha1_RateLimitGRPCConfig(in, out, s); err != nil {
				return err
			}
		}
	}
...
func autoConvert_v3alpha1_RateLimitServiceSpec_To_v2_RateLimitServiceSpec(in *v3alpha1.RateLimitServiceSpec, out *RateLimitServiceSpec, s conversion.Scope) error {
	...
	if true {
		in, out := &in.GRPC, &out.V3GRPC
		if *in == nil {
			*out = nil
		} else {
			*out = new(RateLimitGRPCConfig)
			in, out := *in, *out
			if err := Convert_v3alpha1_RateLimitGRPCConfig_To_v2_RateLimitGRPCConfig(in, out, s); err != nil {
				return err
			}
		}
	}
...
func autoConvert_v2_StatusRange_To_v3alpha1_StatusRange(in *StatusRange, out *v3alpha1.StatusRange, s conversion.Scope) error {
	*out = v3alpha1.StatusRange(*in)
	return nil
}

// Convert_v2_StatusRange_To_v3alpha1_StatusRange is an autogenerated conversion function.
func Convert_v2_StatusRange_To_v3alpha1_StatusRange(in *StatusRange, out *v3alpha1.StatusRange, s conversion.Scope) error {
	return autoConvert_v2_StatusRange_To_v3alpha1_StatusRange(in, out, s)
}

func autoConvert_v3alpha1_StatusRange_To_v2_StatusRange(in *v3alpha1.StatusRange, out *StatusRange, s conversion.Scope) error {
	*out = StatusRange(*in)
	return nil
}

// Convert_v3alpha1_StatusRange_To_v2_StatusRange is an autogenerated conversion function.
func Convert_v3alpha1_StatusRange_To_v2_StatusRange(in *v3alpha1.StatusRange, out *StatusRange, s conversion.Scope) error {
	return autoConvert_v3alpha1_StatusRange_To_v2_StatusRange(in, out, s)
}
